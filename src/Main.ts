...
const aca: Cl_Academia = new Cl_Academia("Matemática", 10, 5);

const asp1: Cl_Aspirante = new Cl_Aspirante("Juan", 1, 2)
const asp2: Cl_Aspirante = new Cl_Aspirante("Carlos", 2, 1)
const asp3: Cl_Aspirante = new Cl_Aspirante("Ana", 1, 1)
const asp4: Cl_Aspirante = new Cl_Aspirante("Raúl", 2, 1)
